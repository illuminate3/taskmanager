...
<form class="form-horizontal" method="post" action="" autocomplete="off">
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-general">
			...
			<!-- Designation -->
			<div class="control-group {{ $errors->has('designation') ? 'error' : '' }}">
				<label class="control-label" for="designation">Designation</label>
				<div class="controls">
					<input type="text" name="designation" id="designation" value="{{ Input::old('designation', $user->designation) }}" />
			...
			<div class="control-group {{ $errors->has('phone_no') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="phone_no" id="phone_no" value="{{ Input::old('phone_no', $user->phone_no) }}" />
					{{ $errors->first('phone_no', '<span class="help-inline">:message</span>') }}
				</div>
			</div>
			...
			<div class="control-group {{ $errors->has('address') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="address" id="address" value="{{ Input::old('address', $user->address) }}" />
				...
				<div class="control-group">
					...
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<label class="radio" for="{{ $permission['permission'] }}_allow" onclick="">
								...
								<label class="radio" for="{{ $permission['permission'] }}_deny" onclick="">
								...
								@if ($permission['can_inherit'])
									<label class="radio" for="{{ $permission['permission'] }}_inherit" onclick="">
